...
#     unlink $fasta_pathname;
#     exit_with_error_msg('Your file contains more than the allowed number of sequences (500K). '
...
if (defined $lsf_job_ID) {
    ...
    exit_with_error_msg("Error submitting the job to LSF.<BR>"
